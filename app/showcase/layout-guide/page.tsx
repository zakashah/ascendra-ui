...
export default function LayoutGuidePage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-8 py-12 flex flex-col gap-14">
      ...
      >
        <Variant label="Standard back link">
      ...
      >
        ...
        <Variant label="Title + description + action">
          <PageHeader>
            <PageHeaderGroup>
        ...
        <Variant label="Title + description + dropdown action">
          <PageHeader>
            <PageHeaderGroup>
      ...
      >
        <Variant label="Standard — back link + header + sections" noPad>
      ...
      >
        ...
        <Variant label="Multiple sections (stacked)">
          <div className="flex flex-col gap-6">
            <MainSection>
              <MainSectionHeader>
      ...
      >
        <Variant label="Single panel item">
          <MainSection>
            <MainSectionHeader>
        ...
        <Variant label="Multiple panel items">
          <MainSection>
            <MainSectionHeader>
      ...
      >
        <Variant label="MainContent + AsideContent" noPad>
