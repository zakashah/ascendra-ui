  ...
  return (
    <>
      ...
      <PageHeader variant="dashboard">
        <PageHeaderGroup>
          <PageTitle>Healthcare Analytics</PageTitle>
          <PageSubtitle>
            Admissions trends, bed occupancy, department performance, and
            patient demographics — clinical operations at a glance.
          </PageSubtitle>
        </PageHeaderGroup>
