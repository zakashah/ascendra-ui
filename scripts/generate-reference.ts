/**
 * Generates docs/components-reference.md from all lib config files.
 *
 * Sources:
...
const lines: string[] = [
  ...
  "",
  `> Auto-generated on ${today} from \`lib/registry.ts\` and all pattern config files.`,
...
console.log(`✓ Generated docs/components-reference.md (${summary})`);
